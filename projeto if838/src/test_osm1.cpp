...
static int recebe_no(const void *user_data, const readosm_node * node)
{
...
main (int argc, char *argv[])
{
    ...
    */
    ...
    FILE* f = fopen("map/map.osm", "r");


    if(!f) std::cout << "não achado!" << std::endl;getchar();
    ...
    */
    ret =
        readosm_parse (osm_handle, (const void *) 0, recebe_no, NULL,
                       NULL);
    if (ret != READOSM_OK)
    {
